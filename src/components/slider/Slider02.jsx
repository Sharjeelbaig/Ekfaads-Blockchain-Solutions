                    ...
                    <div className="slider-inner flex home-1 style-2">
                            ...
                            <div className="button-slider">
                                <Link to="/explore-01"
                                    className="sc-button btn-bordered-white style letter "><span>Explore
                                        More</span></Link>
                                <Link to="/contact"
                                    className="sc-button btn-bordered-white style file"><span>Contact</span></Link>
                            </div>
                        </div>
                        <div className="slider-img flex">
                            ...
                            <div className="img-right">
                                <img src={props.item.img3} alt="Ekfaads" />
                                <div className="box-avatar flex">
                                    <div className="list-avatar flex">
                                        <img src={props.item.avt1} alt="Ekfaads" />
                                        <img src={props.item.avt2} alt="Ekfaads" />
                                        <img src={props.item.avt3} alt="Ekfaads" />
                                        <img src={props.item.avt4} alt="Ekfaads" />
                                    </div>
