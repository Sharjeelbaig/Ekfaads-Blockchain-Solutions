                    ...
                    <div className="col-md-12">
                        ...
                        <div id="site-header-inner" className="flex">
                            <div id="site-logo" className="clearfix">
                                <div id="site-logo-inner">
                                    <Link to="/" rel="home" className="main-logo">
                                        <img id="logo_header" className='logo-dark' src={logo} srcSet={logo2x} alt="Blockchain Developers-gaming" />
                                        <img id="logo_header" className='logo-light' src={logolight} srcSet={logolight2x} alt="Blockchain Developers-gaming" />
                                    </Link>
                                </div>
                            </div>
                            ...
                            <div className="button-connect-wallet">
                                <Link to="/Developers" className="sc-button wallet  style-2">
