                    ...
                    <div className="row">
                        <div className="col-xl-6 col-lg-12 col-md-12">
                            <div className="item-media">
                                <div className="media">
                                    <img src={imgdetail1} alt="Ekfaads" />
                                </div>
                            ...
                            <div className="content-item">
                                ...
                                <div className="author-item">
                                    <div className="avatar">
                                        <img src={avt1} alt="Ekfaads" />
                                    </div>
                                    <div className="infor">
                                        <div className="create">Owner By</div>
                                        <h6><Link to="/Developers">Duane M. Mendoza</Link> </h6>
                                ...
                                <div className="author-bid">
                                    <div className="author-item">
                                        <div className="avatar">
                                            <img src={avt2} alt="Ekfaads" />
                                        </div>
                                        <div className="infor">
                                            <h6><Link to="/Developers">Keith J. Kelley</Link> </h6>
                                            <div className="create">Creators</div>
                                        </div>
                                    </div>
                                    <div className="author-item">
                                        <div className="avatar">
                                            <img src={avt3} alt="Ekfaads" />
                                        </div>
                                        <div className="infor">
                                            <h6><Link to="/Developers">David Michels</Link> </h6>
                                ...
                                <Link to="/Developers"
                                    className="sc-button style letter style-2 style-item-details"><span>More Info</span>
                                </Link>
